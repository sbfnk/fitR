...
# 2) duration of immunity equal to 18 - 2 = 16 days
...
theta.guess1 <- c("R0"=2, "D.lat"=2 , "D.inf"=2, "alpha"=0.8, "D.imm"=16, "rho"=0.7)
state.init.guess1 <- c("S"=279,"E"=0,"I"=2,"T"=3,"L"=0,"Inc"=0)

# Additional assumptions for guess 2
# R0 as in close knit communities (=> larger 1rst wave)
# probability to develop long-term protection equal to seroconversion rate (80%)
theta.guess2 <- c("R0"=10, "D.lat"=2 , "D.inf"=2, "alpha"=0.8, "D.imm"=16, "rho"=0.7)
state.init.guess2 <- c("S"=279,"E"=0,"I"=2,"T"=3,"L"=0,"Inc"=0)
...
theta.guess3 <- c("R0"=10, "D.lat"=2 , "D.inf"=2, "alpha"=0.5, "D.imm"=16, "rho"=0.7)
state.init.guess3 <- c("S"=279,"E"=0,"I"=2,"T"=3,"L"=0,"Inc"=0)
