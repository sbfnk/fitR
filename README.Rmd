...
- [https://github.com/stan-dev/rstan](rstan), an interface to [Stan](https://mc-stan.org/).
- [https://github.com/sbfnk/RBi](rbi), an interface to [LibBi](https://libbi.org/).
- [https://github.com/kingaa/pomp](pomp), for partially observed Markov processes.
