...
#' The SEITL model for pomp, using only R code
#'
#' The SEITL model with constant population size, uniform prior and Poisson observation with reporting rate, as a \code{\link{pomp}} object, using only R code.
#'
#' Look at the documentation of \code{\link{pomp}} for more details about each of these elements.
#' 
#' @format A \code{\link{pomp}} object.
#' @import pomp
#' @name SEITL_pomp_r 
#' @example inst/examples/example-SEITL-pomp-r.r
NULL
...
#' The SEIT2L model for pomp, using only R code
#'
#' The SEIT2L model with constant population size, uniform prior and Poisson observation with reporting rate, as a \code{\link{pomp}} object, using only R code.
#'
#' Look at the documentation of \code{\link{pomp}} for more details about each of these elements.
#' 
#' @format A \code{\link{pomp}} object.
#' @name SEIT2L_pomp_r
#' @import pomp
#' @example inst/examples/example-SEIT2L-pomp-r.r
NULL
...
#' The SEIT4L model for pomp, using only R code
#'
#' The SEIT4L model with constant population size, uniform prior and Poisson observation with reporting rate, as a \code{\link{pomp}} object, using only R code.
#'
#' Look at the documentation of \code{\link{pomp}} for more details about each of these elements.
#' 
#' @format A \code{\link{pomp}} object.
#' @name SEIT4L_pomp_r
#' @import pomp
#' @example inst/examples/example-SEIT4L-pomp-r.r
NULL
